...
public class SmsUpdateReceiver extends BroadcastReceiver {
	...
	private static void beginStartingService(final Context context, final Intent intent) {
     ...
     */
    public static void finishStartingService(final Service service, final int startId) {
        synchronized (mStartingServiceSync) {
            if (mStartingService != null) {
