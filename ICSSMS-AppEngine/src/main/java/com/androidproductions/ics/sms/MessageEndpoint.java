 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "androidproductions.com", ownerName = "androidproductions.com", packagePath = "ics.sms"))
...
public class MessageEndpoint {
     ...
     */
    private static final String API_KEY = "AIzaSyDaqoY2DViOTSe96rp_nX5jd53IR5a8mFw";
