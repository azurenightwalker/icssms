...
import com.androidproductions.ics.sms.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "androidproductions.com", ownerName = "androidproductions.com", packagePath = "ics.sms"))
